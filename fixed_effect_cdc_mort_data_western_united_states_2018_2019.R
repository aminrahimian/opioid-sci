...
#### 
oods_2018 <- cdc_2018_2019_mort_data_west_america %>% 
  filter(year == 2018)
...
oods_2018  <- bind_rows(oods_2018, 
                        missing_data_2018)
#### for  year 2019 ### 
oods_2019 <- cdc_2018_2019_mort_data_west_america %>% 
  filter(year == 2019)
...
write.csv(oods_2018_2019, "C:/Users/kusha/Desktop/Data for Paper/Data From Analysis/Western United States/panel_western.csv")

# 
# #### fixed effects model ###
# library(lfe)
# model_felm_entire_western_united_states<- felm(deaths_per_capita ~ deaths_social_porximity + deaths_spatial_proximity+
#                                          ACS_PCT_HU_NO_VEH+
