...
eastern_american_fips_vector <- oods_2018[order(oods_2018$GEOID),]
eastern_american_fips_vector <- eastern_american_fips_vector$GEOID
### filtering the american_fips_Vector from counties###
selected_counties <- counties[counties$GEOID %in% eastern_american_fips_vector, ]
...
geoid_lat_lng<- data.frame(
  GEOID = eastern_american_fips_vector,
  Longitude = coords[,1],
  Latitude = coords[,2]
)
...
write.csv(oods_2018_2019,'C:/Users/kusha/Desktop/Data for Paper/Data From Analysis/Fixed_effect_panel_data_eastern_us/eastern_united_states_fixed_effect_model.csv')
